...
\section{Steady-State Degradation Curves}
\label{app:ss_degradation_curves}

The following figures present steady-state throughput and wait-time degradation
curves across communication ranges for all main-analysis maps. These curves provide
fine-grained visibility into performance sensitivity to connectivity constraints.
