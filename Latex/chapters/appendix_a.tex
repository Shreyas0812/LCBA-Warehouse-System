...
A condensed cross-map results table will be included in the final
manuscript revision once the remaining steady-state runs are complete.
...
For the current manuscript scope, this appendix keeps the rerun-interval
evidence in summary form rather than adding a standalone figure suite.
...
For the current manuscript scope, this section remains a qualitative
connectivity interpretation rather than a separate appendix scatter plot.
