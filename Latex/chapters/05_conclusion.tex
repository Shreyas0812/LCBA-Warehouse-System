...
evidence, while Kiva is interpreted as a stress-regime robustness case
(see Figures~\ref{fig:ss_kiva_heatmaps_stress} and
\ref{fig:ss_kiva_capacity_progress_stress}).

The remaining steady-state maps will therefore be discussed in the same
