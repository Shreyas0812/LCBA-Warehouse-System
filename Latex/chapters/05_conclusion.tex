...
The stable-regime maps provide primary efficiency evidence, while the stress-regime
cases (Kiva, Kiva-Large, Shelf-Aisle) demonstrate robustness under extreme conditions
(see Figures~\ref{fig:ss_kiva_heatmaps_stress}, \ref{fig:ss_kiva_large_heatmaps_stress},
and \ref{fig:ss_shelf_aisle_heatmaps_stress}).

The batch results demonstrate that LCBA achieves robust performance and interpretability
across regimes that matter for the main thesis claims: communication robustness,
optimality preservation, and scalability under load. Performance depends on map
difficulty and load conditions, and should be interpreted within each specific
experimental context rather than as a universal superiority condition.
