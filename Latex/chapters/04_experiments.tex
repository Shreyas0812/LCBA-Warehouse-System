...
\texttt{gridworld\_crossdock} are available and plotted.
The remaining maps will be inserted using the same compact-view structure used for
batch: throughput, wait-time, completion, queue-depth, capacity frontier,
tradeoff, and degradation-by-communication-range.

Current steady-state compact-view path:
\begin{itemize}
  \item \texttt{results/experiments/gridworld\_warehouse\_small/20260425\_133314/ss\_results/compact\_views/}
  \item \texttt{results/experiments/gridworld\_crossdock/20260425\_142347/ss\_results/compact\_views/}
\end{itemize}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_warehouse_small/20260425_133314/ss_results/compact_views/compact_heatmap_throughput.png}
    \caption{Warehouse-small: throughput}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_warehouse_small/20260425_133314/ss_results/compact_views/compact_heatmap_wait_time.png}
    \caption{Warehouse-small: wait time}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_warehouse_small/20260425_133314/ss_results/compact_views/compact_heatmap_queue_depth.png}
    \caption{Warehouse-small: queue depth}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_crossdock/20260425_142347/ss_results/compact_views/compact_heatmap_throughput.png}
    \caption{Crossdock: throughput}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_crossdock/20260425_142347/ss_results/compact_views/compact_heatmap_wait_time.png}
    \caption{Crossdock: wait time}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_crossdock/20260425_142347/ss_results/compact_views/compact_heatmap_queue_depth.png}
    \caption{Crossdock: queue depth}
  \end{subfigure}
  \caption{Steady-state core heatmaps for currently completed SS maps. Rows are maps and columns are core metrics, matching the compact batch-style comparison layout while using arrival-rate/communication-range axes.}
  \label{fig:ss_heatmaps_current_maps}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_warehouse_small/20260425_133314/ss_results/compact_views/compact_capacity_curve.png}
    \caption{Warehouse-small: capacity frontier}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_warehouse_small/20260425_133314/ss_results/compact_views/compact_tradeoff.png}
    \caption{Warehouse-small: throughput--wait tradeoff}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_warehouse_small/20260425_133314/ss_results/compact_views/compact_throughput_degradation_by_comm_range.png}
    \caption{Warehouse-small: throughput degradation}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_crossdock/20260425_142347/ss_results/compact_views/compact_capacity_curve.png}
    \caption{Crossdock: capacity frontier}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_crossdock/20260425_142347/ss_results/compact_views/compact_tradeoff.png}
    \caption{Crossdock: throughput--wait tradeoff}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../results/experiments/gridworld_crossdock/20260425_142347/ss_results/compact_views/compact_throughput_degradation_by_comm_range.png}
    \caption{Crossdock: throughput degradation}
  \end{subfigure}
  \caption{Steady-state frontier/tradeoff/degradation summary for currently completed SS maps.}
  \label{fig:ss_frontier_tradeoff_degradation_current_maps}
\end{figure}
...
\begin{itemize}
  ...
  \item \texttt{compact\_heatmap\_completion\_rate.png}
  \item \texttt{compact\_heatmap\_queue\_depth.png}
  \item \texttt{compact\_capacity\_curve.png}
  \item \texttt{compact\_tradeoff.png}
  \item \texttt{compact\_throughput\_degradation\_by\_comm\_range.png}
  \item \texttt{compact\_wait\_time\_degradation\_by\_comm\_range.png}
\end{itemize}

Pending steady-state map folders (currently running):
\begin{itemize}
  \item \texttt{results/experiments/gridworld\_kiva/<ss\_timestamp>/ss\_results/compact\_views/}
