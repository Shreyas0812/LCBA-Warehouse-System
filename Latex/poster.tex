...
\block{Simulation Environments}{
    \begin{center}
        \begin{minipage}[t]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{example-image-a}
            \vspace{0.1cm} \\
            {\textbf{1.} \texttt{warehouse\_small}}
        \end{minipage}\hfill
        \begin{minipage}[t]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{example-image-b}
            \vspace{0.1cm} \\
        ...
        \begin{minipage}[t]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{example-image-c}
            \vspace{0.1cm} \\
