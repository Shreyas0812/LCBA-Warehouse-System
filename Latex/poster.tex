...
\block{Simulation Environments}{
    \begin{center}
        \begin{minipage}[c]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{figures/gridworld_warehouse_small/gridworld_warehouse_small.png} \\[4pt]
            \textbf{Warehouse Small} \\ {\small 30$\times$30, 6 agents}
        \end{minipage}\hfill
        \begin{minipage}[c]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{figures/gridworld_crossdock/gridworld_crossdock.png} \\[4pt]
        ...
        \begin{minipage}[c]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{figures/gridworld_warehouse_large/gridworld_warehouse_large.png} \\[4pt]
            \textbf{Warehouse Large} \\ {\small 60$\times$60, 18 agents}
        \end{minipage}\hfill
        \begin{minipage}[c]{0.48\linewidth}
            \centering
            \includegraphics[width=\linewidth, height=9cm, keepaspectratio]{figures/gridworld_kiva/gridworld_kiva.png} \\[4pt]
