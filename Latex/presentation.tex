...
\begin{frame}{Where CBBA and GCBBA Break}
  ...
  \begin{columns}[T]
    \begin{column}{0.32\textwidth}
      \begin{numcard}{1}
        \subheader{Bundle Construction}\par\vspace{4pt}
    ...
    \begin{column}{0.32\textwidth}
      \begin{numcard}{2}
        \subheader{Consensus}\par\vspace{4pt}
    ...
    \begin{column}{0.32\textwidth}
      \begin{numcard}{3}
        \subheader{Convergence}\par\vspace{4pt}
...
\begin{frame}{LCBA: Three Key Relaxations over GCBBA}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{numcard}{1}
        \subheader{Component-Local Consensus}\par\vspace{4pt}
      ...
      \vspace{6pt}
      \begin{numcard}{2}
        \subheader{Timestamped Conflict Resolution}\par\vspace{4pt}
      ...
      \vspace{6pt}
      \begin{numcard}{3}
        \subheader{Event-Driven Replanning}\par\vspace{4pt}
    ...
    \begin{column}{0.42\textwidth}
      ...
      \end{infobox}
      \vspace{8pt}
      \subheader{Research Questions}\par\vspace{6pt}
      {\rmfamily\small
      \begin{tightitemize}
        \item \rqlabel{RQ1}\,
