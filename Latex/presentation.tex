  ...
  \begin{columns}[T]
    \begin{column}{0.54\textwidth}
      ...
      \subheader{Five Contributions}\par\vspace{4pt}
        ...
        \vspace{8pt}
      \subheader{\textcolor{TextMuted}{01}\hspace{6pt}LCBA Algorithm}\par\vspace{1pt}
      ...
      \vspace{8pt}
      \subheader{\textcolor{TextMuted}{02}\hspace{6pt}Hybrid Pipeline}\par\vspace{1pt}
      \smallcap{Modular allocation + 3 interchangeable path planners; layers independently configurable.}

      \vspace{8pt}
      \subheader{\textcolor{TextMuted}{03}\hspace{6pt}Dual-Mode Simulation}\par\vspace{1pt}
      \smallcap{Batch (completion, makespan) and steady-state (throughput, wait, queue depth) in one environment.}

      % \vspace{6pt}
      % \subheader{\textcolor{TextMuted}{04}\hspace{6pt}Empirical Evaluation}\par\vspace{1pt}
      % \smallcap{432+ runs, 6 environments, 6--200 agents, full factorial sweep.}

      \vspace{8pt}
      \subheader{\textcolor{TextMuted}{05}\hspace{6pt}Operational Realism}\par\vspace{1pt}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}\raggedright
      ...
      \begin{tightitemize}
        ...
        \item \textbf{Hardware validation:} basic deployment on some hardware.
